...
<H2 ALIGN=LEFT>Release 2-8-3</H2>
<ul>
<li>Added bob files, updated ui and edl files.
</ul>
	
<H2 ALIGN=LEFT>Release 2-8-2</H2>
<ul>
<li>Req files now installed to top level db folder.</li>
</ul>
	
<H2 ALIGN=LEFT>Release 2-8 </H2>
<ul>

<li>Custom interrupt service routines registered with softGlue now receive
16 bit masks wentLow and wentHigh, describing which bit went low or high to
trigger the interrupt

</ul>

<H2 ALIGN=LEFT>Release 2-7 </H2>
<ul>


<li>Added 32-bit magnitude comparator.

<li>Add-on component to produce time-averaged value of an encoder
(SoftGlue_2_2_encoder_ave.hex)

</ul>

<H2 ALIGN=LEFT>Release 2-6 </H2>
<ul>

<li>Added four-output demultiplexer (SoftGlue_2_2_demux4.hex).
<li>Added four-output demultiplexer with output lines hardwired to last 16 field
I/O pins (hardwired to last 16 field I/O pins).

</ul>

<H2 ALIGN=LEFT>Release 2-5 </H2>
<ul>

<li>Reworked displays for caQtDM.
<li>label all displays with $(P)$(H), so users know which instance of softGlue
they're looking at.
<li>Fix for Windows build.
<li>Added powerpoint presentation.
<li>Previously, the number of signals in use wasn't updated at boot time.
